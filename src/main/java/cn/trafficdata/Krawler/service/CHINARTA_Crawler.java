 ...
 */
public class CHINARTA_Crawler extends DocumentUtils implements ProcessDao {
    public List<WebURL> pageListHandler(Page page) {
        ...
        try{
            Elements linkEls=doc.select("div[class=newsChannelContent] div[class=newsInfo]");
    ...
    public boolean processDoc(Page page) {
        ...
        Element imgElement=doc.select("div[class=newsDetailsContent]").first();
